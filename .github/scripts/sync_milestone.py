...
PARENT_MILESTONE_NUMBER = os.environ.get("PARENT_MILESTONE_NUMBER")
...
# --- Validate PARENT_MILESTONE_NUMBER ---
...
# Determine milestone value for REST API
...
print(f"Determined Milestone Payload for Sub-issues: {milestone_payload_value}")
...
print(f"Sub-issues Add-to-Project Attempted (Success/Already Present): {len(sub_issues)}")
