...
core_headers = [
    ...
    'issue_type_id', 'issue_type_name'   # -- CHANGED/ADDED for issueType --
]
...
for item in all_items:
    ...
    row['issue_type_id'] = ''   # -- ADDED: default empty
    row['issue_type_name'] = '' # -- ADDED: default empty
    ...
    if content:
        ...
        # -- CHANGED/ADDED: extract issueType if present --
