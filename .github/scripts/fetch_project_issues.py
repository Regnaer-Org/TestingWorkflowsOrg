...
try:
    ...
    chicago_offset = timedelta(hours=-5)
          ...
          fieldValues(first: 100) { # Get all custom fields for the item
            nodes {
              ... on ProjectV2ItemFieldTextValue {
                text
                field { ...ProjectV2FieldCommon } # Use Fragment
              }
              ...
              # Add fragments for other field types if needed and update ProjectV2FieldCommon fragment below
            }
          }
          content {
            ... on DraftIssue {
              ...
              title
              body
              # CORRECTED: Use 'creator' field directly
              creator { login }
            }
            ... on PullRequest {
              id
...
# CORRECTED: Fragment is now used above
